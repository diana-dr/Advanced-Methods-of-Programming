...
public class selectController implements Initializable {
    ...
    private void addProgramsStatements() {
        ...
        IStmt ex11 = new CompStmt(new VarDeclStmt("v1", new RefType(new IntType())), new CompStmt(new VarDeclStmt("v2", new RefType(new IntType())),
                new CompStmt(new VarDeclStmt("v3", new RefType(new IntType())), new CompStmt(new NewStmt("v1", new ValueExp(new IntValue(2))),
                        new CompStmt(new NewStmt("v2", new ValueExp(new IntValue(3))), new CompStmt(new NewStmt("v3", new ValueExp(new IntValue(4))),
                new CompStmt(new NewLatch("cnt", new rH(new VarExp("v2"))), new CompStmt(
                        new forkStmt(new CompStmt(new wH("v1", new ArithExp(3, new rH(new VarExp("v1")), new ValueExp(new IntValue(10)))),
                ...
                new CompStmt(new forkStmt(
                        ...
                        new CompStmt(new forkStmt(new CompStmt(new wH("v3", new ArithExp(3, new rH(new VarExp("v3")), new ValueExp(new IntValue(10)))),
                        new CompStmt(new PrintStmt(new rH(new VarExp("v3"))),
                        new CompStmt(new CountDownStmt("cnt"), new NopStmt())))), new NopStmt())))
                )), new NopStmt()))))), new CompStmt(new AwaitStmt("cnt"), new CompStmt(new PrintStmt(new ValueExp(new IntValue(100))),
                        new CompStmt(new CountDownStmt("cnt"), new CompStmt(new PrintStmt(new ValueExp(new IntValue(100))), new NopStmt()))))))))))));
