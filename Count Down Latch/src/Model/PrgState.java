...
import Model.DataStructures.CDL.CountDownTable;
...
public class PrgState {
    ...
    private ICountDown<Integer, Integer> cdlTable;

    public PrgState(ICountDown<Integer, Integer> cdl, MyIStack<IStmt> stk, MyIDictionary<String, Value> symtbl, MyIList<Value> ot, IFileTable<String, BufferedReader> fTable, MyIHeap<Value> heapTable,
             int id, IStmt prg)
    {
        cdlTable = cdl;
        exeStack = stk;
    ...
    public void setCdlTable(ICountDown<Integer, Integer> cdlTable) {
        this.cdlTable = cdlTable;
    }

    public ICountDown<Integer, Integer> getCdlTable() {
        return cdlTable;
    }

    public PrgState(IStmt prg){

        cdlTable = new CountDownTable<>();
