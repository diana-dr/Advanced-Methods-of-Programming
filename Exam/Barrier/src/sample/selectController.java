...
public class selectController implements Initializable {
    ...
    @FXML
    private void handleExecButton() throws MyException {
...
//        print(rH(v3))
        ...
        IStmt ex11 = new CompStmt(new VarDeclStmt("v1", new RefType(new IntType())), new CompStmt( new VarDeclStmt("cnt", new IntType()),
                new CompStmt( new AssignStmt("cnt", new ValueExp(new IntValue(0))), new CompStmt(
                new VarDeclStmt("v2", new RefType(new IntType())), new CompStmt(new VarDeclStmt("v3", new RefType(new IntType())), new CompStmt(
                        new NewStmt("v1", new ValueExp(new IntValue(2))), new CompStmt(new NewStmt("v2", new ValueExp(new IntValue(3))),
                new CompStmt(new NewStmt("v3", new ValueExp(new IntValue(4))), new CompStmt(new BarrierStmt(new VarExp("cnt"), new rH(new VarExp("v2"))),
                        new CompStmt(new forkStmt(new CompStmt(new AwaitStmt(new VarExp("cnt")), new CompStmt(new wH("v1", new ArithExp(3,
                                new rH(new VarExp("v1")), new ValueExp(new IntValue(10)))), new CompStmt(new PrintStmt(
                                        new rH(new VarExp("v1"))), new NopStmt())))), new CompStmt(new forkStmt(new CompStmt(new AwaitStmt(new VarExp("cnt")), new CompStmt(
                                                new wH("v2", new ArithExp(3, new rH(new VarExp("v2")), new ValueExp(new IntValue(10)))),
                                new CompStmt(new wH("v2", new ArithExp(3, new rH(new VarExp("v2")), new ValueExp(new IntValue(10)))),
                                        new CompStmt(new PrintStmt(new rH(new VarExp("v2"))), new NopStmt()))))), new CompStmt(new AwaitStmt(new VarExp("cnt")),
                                                new CompStmt(new PrintStmt(new rH(new VarExp("v3"))), new NopStmt())))))))))))));
